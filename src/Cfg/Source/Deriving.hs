...
-- --
-- -- @since 0.0.5.0
-- instance (AssertTopLevelRecord ConfigTree a, Generic a, GConfigTree1 a) => ConfigTree (ConfigRoot a) where
--   toTree = defaultToTree
--
...
--   IsTopLevelRecord (M1 i c f) = 'False
